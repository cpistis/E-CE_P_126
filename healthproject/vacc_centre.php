...
<html>
	<head>
		<meta charset="utf-8">
		<title>Κέντρα Εμβολιασμού - Healthcare Express</title>
	...
	<body>
				...
				<?php
				    ...
				    $result = $conn-> query($sql);
						   if($result-> num_rows > 0){
						    	...
						    	echo "<tr><td>" . $row["City"] ."</td><td>" . $row["Centrename"] . "</td><td>" . $row["Section"] . "</td><td>" . $row["Telephone"] . "</td>";
						    	}
						    echo "</table>";
						    }
						    		else{
	    ...
	    <p style="font-size:15px;margin-left: 330px;">*For more information click <a href="https://help.unhcr.org/cyprus/covid-19-coronavirus/" target="_blank" style="text-decoration: underline;color: black;"><b>here</b></a></p>	
