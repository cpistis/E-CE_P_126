	...
	<body>
		...
		<div id="mySidebar" class="sidebar">
		  ...
		  <ul style="list-style-type:square">
		  	...
		  	<a  href="./pharma.html" style="color: #f1f1f1; font-size:18px">Φαρμακεία</a>
		  </ul>
		...
		<p class="donthave">Δεν έχετε ακόμη λογαριασμό; Εγγραφείτε <a href="./signup.php" class="donthave"><b>εδώ</b></a></p>
