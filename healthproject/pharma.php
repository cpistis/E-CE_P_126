...
<html>
	<head>
		<meta charset="utf-8">
		<title>Φαρμακεία - Healthcare Express</title>
	...
	<body>
		...
		<table align="center">
				...
				<?php
				    ...
				    $sql = "SELECT Name, Telephone, City, Address FROM Pharmacy;";
				    $result = $conn-> query($sql);
						   if($result-> num_rows > 0){
						    	while($row = $result-> fetch_assoc()){
						    	echo "<tr><td>" . $row["Name"] ."</td><td>" . $row["Telephone"] . "</td><td>" . $row["City"] . "</td><td>" . $row["Address"] . "</td>";
						    	}
						    echo "</table>";
						    }
						    		else{
